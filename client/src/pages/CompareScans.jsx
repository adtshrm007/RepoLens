...
export default function CompareScans() {
  ...
  const ROWS = [
    ...
    { label: "Total LOC", keyA: d => (d.metrics?.totalLines ?? 0).toLocaleString(), keyB: d => (d.metrics?.totalLines ?? 0).toLocaleString(), higherBetter: false },
    ...
    { label: "Max Nesting", keyA: d => d.metrics?.maxNestingDepth ?? 0, keyB: d => d.metrics?.maxNestingDepth ?? 0, higherBetter: false },
